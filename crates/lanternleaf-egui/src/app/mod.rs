...
struct LanternLeafApp {
    ...
    pretty_stable_witness: Option<ui::reader::PrettyViewportWitness>,
    pretty_reflow_transaction: Option<ui::reader::PrettyReflowTransaction>,
...
struct StarterViewModel<'a> {
    ...
    calibre_catalog_complete: bool,
    calibre_catalog_loaded_count: usize,
    calibre_catalog_total: Option<usize>,
    calibre_catalog_error: Option<&'a String>,
...
impl<'a> StarterViewModel<'a> {
    fn from_state(state: &'a AppState) -> Self {
        Self {
            ...
            calibre_catalog_complete: state.starter.calibre_catalog_complete,
            calibre_catalog_loaded_count: state.starter.calibre_catalog_loaded_count,
            calibre_catalog_total: state.starter.calibre_catalog_total,
            calibre_catalog_error: state.starter.calibre_catalog_error.as_ref(),
...
impl LanternLeafApp {
    ...
    fn new(
        ...
        let mut app = Self {
            ...
            pretty_stable_witness: None,
            pretty_reflow_transaction: None,
